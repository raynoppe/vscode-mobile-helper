...
function activate(context) {
    ...
    const showToolbarCommand = vscode.commands.registerCommand('mobile-helper.showToolbar', () => {
        ...
        const panel = vscode.window.createWebviewPanel('mobileToolbar', // Identifies the type of the webview. Used internally
        ...
        panel.webview.onDidReceiveMessage(message => {
            ...
            switch (message.command) {
                case 'moveCursor': {
                    ...
                    let commandArgs = { value: 1, select: isSelecting };
                    if (direction === 'up') {
                        commandArgs.to = 'up';
                        commandArgs.by = 'line';
                    }
